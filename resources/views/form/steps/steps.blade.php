...
<input type="hidden" class="current-step-input" name="{{ RuiYi\LaAdmin\Form\Steps\Builder::CURRENT_VALIDATION_STEP }}" />
<input type="hidden" class="all-steps-input" name="{{ RuiYi\LaAdmin\Form\Steps\Builder::ALL_STEPS }}" />
