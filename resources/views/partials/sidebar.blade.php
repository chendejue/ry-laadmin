                            ...
                            <div class="navbar-collapse d-flex justify-content-between">
                                <div class="navbar-left d-flex align-items-center">
                                    <ul class="nav  nav-pills nav-sidebar {{ $configData['horizontal_menu'] ? '' : 'flex-column' }}"
                                        ...
                                        @endif
                                        {!! admin_section(RuiYi\LaAdmin\Admin::SECTION['LEFT_SIDEBAR_MENU_TOP']) !!}

                                        {!! admin_section(RuiYi\LaAdmin\Admin::SECTION['LEFT_SIDEBAR_MENU']) !!}

                                        {!! admin_section(RuiYi\LaAdmin\Admin::SECTION['LEFT_SIDEBAR_MENU_BOTTOM']) !!}
                                    </ul>
                                </div>
                                <div class="navbar-right d-flex align-items-center">
                                    {!! RuiYi\LaAdmin\Admin::navbar()->render() !!}
                                    ...
                                    <ul class="nav navbar-nav">
                                        {{--User Account Menu--}}
                                        {!! admin_section(RuiYi\LaAdmin\Admin::SECTION['NAVBAR_USER_PANEL']) !!}

                                        {!! admin_section(RuiYi\LaAdmin\Admin::SECTION['NAVBAR_AFTER_USER_PANEL']) !!}
                                    </ul>
                                </div>
                            </div>
                        </div>
