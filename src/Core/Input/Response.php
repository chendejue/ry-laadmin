...
namespace RuiYi\LaAdmin\Core\Input;

use Illuminate\Http\JsonResponse;
use RuiYi\LaAdmin\Misc\Laravel\Input;
use Illuminate\Support\Facades\View;
use RuiYi\LaAdmin\Exception\BizException;
use RuiYi\LaAdmin\Core\Util\FileUtil;
use RuiYi\LaAdmin\Core\Util\SerializeUtil;
...
class Response
{
    ...
    {
        if (null === $redirect) {
            if ($_redirect = trim(Request()->get('_redirect'))) {
                $redirect = $_redirect;
            }
        }
        $response = [
    ...
    public static function quit($code, $msg, $data = null, $redirect = null)
    {
        ...
        if (\Illuminate\Support\Facades\Request::ajax()) {
            ...
            echo View::make('admin::core.msg.msg', $response)->render();
        }
        exit();
    }
    ...
    public static function send($code, $msg, $data = null, $redirect = null)
    {
        if (\Illuminate\Support\Facades\Request::ajax()
            ...
            return view('admin::core.msg.msg', $response);
        }
    }
