...
class Manager
{
    ...
    public function resolveExtension(string $directory, bool $addPsr4 = true)
    {
        ...
        $serviceProvider = $composerProperty->get('extra.ruiyi-laadmin');
     ...
     * 添加扩展.
     *
     * @param  \RuiYi\LaAdmin\Extend\ServiceProvider  $serviceProvider
     */
