...
use Closure;
use RuiYi\LaAdmin\Form as ParentForm;
use RuiYi\LaAdmin\Http\JsonResponse;
use RuiYi\LaAdmin\Form\Steps\Form;
...
class Builder
{
    ...
    /**
     * @param string|\RuiYi\LaAdmin\Form\Field $field
     *
     * @return void
     */
...
JS;
    ...
    /**
     * @param string|\RuiYi\LaAdmin\Form\Field $column
     *
     * @return false|int
     */
