...
namespace RuiYi\LaAdmin\Form\Extend\FormMedia\Form;

use Illuminate\Support\Facades\Storage;
use RuiYi\LaAdmin\Form\Field as BaseField;
use RuiYi\LaAdmin\Form\Extend\FormMedia\MediaManager;
...
{
    protected $view = 'admin::form.extend.form-media.field-iconimg';
