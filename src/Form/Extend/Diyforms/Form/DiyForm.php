	...
	public function addComponentType($item)
	{
		...
		foreach ($needs as $need) {
			if (!in_array($need, $keys)) {
				admin_exit(
					Content::make()
						->body(Alert::make("缺少必须项 {$need}", 'RuiYi Diy Form Error')->danger())
				);
			}
		}
