...
namespace RuiYi\LaAdmin\Layout;

use RuiYi\LaAdmin\Admin;
use RuiYi\LaAdmin\Color;
...
class Asset
{
    ...
    protected $alias = [
        // 静态资源路径别名
        '@admin' => 'vendor/ruiyi/laadmin',
        // 扩展静态资源路径别名
        '@extension' => 'vendor/ruiyi/laadmin/extensions',
    ...
    public function withVersionQuery($url)
    {
        ...
        $ver = 'v'.\RuiYi\LaAdmin\Support\Helper::getPackageVersion('dcat-plus/laravel-admin');
