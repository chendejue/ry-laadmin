...
if (! function_exists('admin_setting')) {
     ...
     * @param  mixed  $default
     * @return \RuiYi\LaAdmin\Support\Setting|mixed
     */
...
if (! function_exists('admin_extension_setting')) {
    ...
    function admin_extension_setting($extension, $key = null, $default = null)
    {
        ...
        if ($extension instanceof RuiYi\LaAdmin\Extend\ServiceProvider) {
...
if (! function_exists('admin_toastr')) {
    ...
    function admin_toastr($message = '', $type = 'success', $options = [])
    {
        ...
        session()->flash('ruiyi-laadmin-toastr', $toastr);
    }
}
...
if (! function_exists('admin_extension_path')) {
    ...
    {
        $dir = rtrim(config('admin.extension.dir'), '/') ?: base_path('ruiyi-laadmin-extensions');
...
if (! function_exists('admin_color')) {
     ...
     * @return string|\RuiYi\LaAdmin\Color
     */
...
if (! function_exists('admin_javascript')) {
    ...
    {
        return RuiYi\LaAdmin\Support\JavaScript::make($scripts);
    }
}
...
if (! function_exists('admin_javascript_json')) {
    ...
    {
        return RuiYi\LaAdmin\Support\JavaScript::format($data);
    }
}
