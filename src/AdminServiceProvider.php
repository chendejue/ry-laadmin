...
use RuiYi\LaAdmin\Exception\Handler;
use RuiYi\LaAdmin\Extend\Manager;
use RuiYi\LaAdmin\Extend\UpdateManager;
use RuiYi\LaAdmin\Extend\VersionManager;
use RuiYi\LaAdmin\Form\Extend;
use RuiYi\LaAdmin\Form\Extend\Distpicker\DcatDistpickerServiceProvider;
use RuiYi\LaAdmin\Form\Extend\Diyforms\DcatDiyFormServiceProvider;
use RuiYi\LaAdmin\Form\Extend\FormMedia\FormMediaServiceProvider;
use RuiYi\LaAdmin\Form\Steps\FormStepServiceProvider;
use RuiYi\LaAdmin\Layout\Asset;
...
use RuiYi\LaAdmin\Support\Context;
use RuiYi\LaAdmin\Support\Helper;
use RuiYi\LaAdmin\Support\Setting;
use RuiYi\LaAdmin\Support\Translator;
use RuiYi\LaAdmin\Support\WebUploader;
...
class AdminServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        \RuiYi\LaAdmin\Widgets\Tooltip::make('.tips')->purple();
    ...
    protected function registerPublishing() {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__ . '/../config' => config_path()], 'ruiyi-laadmin-config');
            $this->publishes([__DIR__ . '/../resources/lang' => $this->app->langPath()], 'ruiyi-laadmin-lang');
            $this->publishes([__DIR__ . '/../database/migrations' => database_path('migrations')], 'ruiyi-laadmin-migrations');
            $this->publishes([__DIR__ . '/../resources/dist' => public_path(Admin::asset()->getRealPath('@admin'))], 'ruiyi-laadmin-assets');
        }
    }
