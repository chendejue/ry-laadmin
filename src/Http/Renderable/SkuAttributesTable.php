...
class SkuAttributesTable extends LazyRenderable
{
    ...
    public function grid(): Grid
    {
        return Grid::make(new SkuAttribute(), function (Grid $grid) {
            ...
            \RuiYi\LaAdmin\Form::dialog('添加规格')
                ->click('.add-sku')
                ->success('Dcat.reload()')
