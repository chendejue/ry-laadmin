...
use RuiYi\LaAdmin\Http\Auth\Permission;
use RuiYi\LaAdmin\Layout\Content;
use RuiYi\LaAdmin\Scaffold\ControllerCreator;
use RuiYi\LaAdmin\Scaffold\ApiControllerCreator;
use RuiYi\LaAdmin\Scaffold\LangCreator;
use RuiYi\LaAdmin\Scaffold\MigrationCreator;
use RuiYi\LaAdmin\Scaffold\ModelCreator;
use RuiYi\LaAdmin\Scaffold\RepositoryCreator;
use RuiYi\LaAdmin\Scaffold\ResourceCreator;
...
class ScaffoldController extends Controller {
    ...
    public function index(Content $content) {
        ...
        $menu_parent_selectOptions = \RuiYi\LaAdmin\Models\Menu::selectOptions();
        return $content
