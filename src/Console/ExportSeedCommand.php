...
class ExportSeedCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'ryadmin:export-seed {classname=AdminTablesSeeder}
     ...
     * @var string
     */
    protected $description = 'Export seed a ruiyi-laadmin database tables menu, roles and permissions';
