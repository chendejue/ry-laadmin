...
namespace RuiYi\LaAdmin\Widgets;

use Closure;
use RuiYi\LaAdmin\Admin;
use RuiYi\LaAdmin\Contracts\LazyRenderable;
use RuiYi\LaAdmin\Exception\RuntimeException;
use RuiYi\LaAdmin\Form\Concerns\HandleCascadeFields;
use RuiYi\LaAdmin\Form\Concerns\HasLayout;
use RuiYi\LaAdmin\Form\Concerns\HasRows;
use RuiYi\LaAdmin\Form\Concerns\HasTabs;
use RuiYi\LaAdmin\Form\Field;
use RuiYi\LaAdmin\Form\ResolveField;
use RuiYi\LaAdmin\Support\Helper;
use RuiYi\LaAdmin\Traits\HasAuthorization;
use RuiYi\LaAdmin\Traits\HasFormResponse;
use RuiYi\LaAdmin\Traits\HasHtmlAttributes;
...
class Form implements Renderable
{
    ...
    public function validate(Request $request)
    {
        ...
        /** @var \RuiYi\LaAdmin\Form\Field $field */
        foreach ($this->fields() as $field) {
    ...
    {
        $class = Arr::get(\RuiYi\LaAdmin\Form::extensions(), $method);
