...
namespace RuiYi\LaAdmin\Repositories;

use RuiYi\LaAdmin\Contracts\Repository as RepositoryInterface;
use RuiYi\LaAdmin\Contracts\TreeRepository;
use RuiYi\LaAdmin\Form;
use RuiYi\LaAdmin\Grid;
use RuiYi\LaAdmin\Show;
...
abstract class Repository implements RepositoryInterface, TreeRepository
{
     ...
     *
     * @param  Form  $form
     * @return int|bool|\RuiYi\LaAdmin\Http\JsonResponse
     */
     ...
     *
     * @param  Form  $form
     * @return bool|\RuiYi\LaAdmin\Http\JsonResponse
     */
     ...
     * @return bool|int|\RuiYi\LaAdmin\Http\JsonResponse
     */
