   ...
   */
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => RuiYi\LaAdmin\Models\Administrator::class,
            ],
        ],
    ...
    */
    'grid' => [
        ...
        'grid_action_class' => RuiYi\LaAdmin\Grid\Displayers\DropdownActions::class,

        // The global Grid batch action display class.
        'batch_action_class' => RuiYi\LaAdmin\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => RuiYi\LaAdmin\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => RuiYi\LaAdmin\Grid\Actions\Show::class,
            'edit' => RuiYi\LaAdmin\Grid\Actions\Edit::class,
            'quick_edit' => RuiYi\LaAdmin\Grid\Actions\QuickEdit::class,
            'delete' => RuiYi\LaAdmin\Grid\Actions\Delete::class,
            'batch_delete' => RuiYi\LaAdmin\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => RuiYi\LaAdmin\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => RuiYi\LaAdmin\Models\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => RuiYi\LaAdmin\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => RuiYi\LaAdmin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => RuiYi\LaAdmin\Models\Menu::class,
    ...
    */
    ...
    |
    */
    'exception_handler' => RuiYi\LaAdmin\Exception\Handler::class,
